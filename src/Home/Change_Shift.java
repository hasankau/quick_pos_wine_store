 ...
 * @author HASANKA
 */
public class Change_Shift extends PopupFrame {
    Home home = null;
    String table;
    Cashier cashier;
    /**
     ...
     * @param cashier
     */
    public Change_Shift(Home home, Cashier cashier) {
        this();
        this.home = home;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cash In Drawer ");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("*****");

        jLabel5.setText("Shift started");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ql.saveLogout(home.getCurrentUser().getId(), sdft.format(new Date()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Change_Shift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Change_Shift().setVisible(true);
            }
        });
    }
