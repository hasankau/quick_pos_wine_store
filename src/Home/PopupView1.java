 ...
 * @author HASANKA
 */
public class PopupView1 extends PopupFrame {
     ...
     * @param table
     */
    public PopupView1(Home home, Cashier cashier, Item item) {
        this();
        this.home = home;
    ...
    private void setItem() {
        itemcode.setText(item.getBarcode());
        name.setText(item.getName());
        setTypes(item.getBarcode());
    }

    private void setTypes(String barc) {
        desc.setModel(new DefaultComboBoxModel(db.loadSubTypes(barc)));
    }
    ...
    private void finish() {
        ...
        if (!price.getText().isEmpty()&!qty.getText().isEmpty()) {
            double d = Double.parseDouble(price.getText().trim());
            if (!Double.isNaN(d) && d > 0) {
                item.setCash_price(price.getText());
                item.setName(name.getText());
                item.setQty(qty.getText());
                cashier.addNonItem(item);
                dispose();
            } else {
    ...
    private void setHotKeys(){
        jButton6.setMnemonic(KeyEvent.VK_X);
    }
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(name, javax.swing.GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(desc, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupView1().setVisible(true);
            }
        });
    }
